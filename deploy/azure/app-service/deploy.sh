#!/usr/bin/env bash
# Deploy DORA Dashboard to Azure App Service (Web App for Containers).
...
echo "Bootstrap admin password is generated on first run — check logs:"
echo "  az webapp log tail -g $RG -n dora"
